...
const EditNote = () => {
  ...
  if (isLoading) {
    return (
      <main className='min-h-screen p-6 md:p-10 bg-green-600 flex items-center justify-center'>
      ...
      <div className='max-w-3xl mx-auto'>
        <div className='flex items-center justify-between mb-8'>
          <button
            ...
            className='text-green-600/60 hover:text-white transition-colors inline-flex items-center gap-2'
          >
            <ArrowLeft size={20} />
            Back to Notes
          </button>
